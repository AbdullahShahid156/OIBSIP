...
<head>
  ...
  <title>Verify Your Email - PizzaCraft</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#141518;border-radius:16px;border:1px solid rgba(255,255,255,0.06);overflow:hidden;">
          ...
          <tr>
            <td style="padding:0 40px;text-align:center;">
              ...
              <p style="color:rgba(255,255,255,0.5);font-size:14px;margin:0 0 32px;">Hi ${name}, welcome to PizzaCraft!</p>
            </td>
          </tr>
          <tr>
            <td style="padding:0 40px;text-align:center;">
...
function getVerificationEmailText(name, url) {
  return `Hi ${name},\n\nWelcome to PizzaCraft! Please verify your email address by visiting:\n\n${url}\n\nThis link will expire in 24 hours.\n\nIf you didn't create an account, you can safely ignore this email.\n\n© ${new Date().getFullYear()} PizzaCraft`;
}

export { getVerificationEmailHTML, getVerificationEmailText };
